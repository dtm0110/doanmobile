...
import 'job_favorite_vm.dart';
import '../../../extension/number_extension.dart';

class JobFavoriteView extends StatelessWidget {
  static const routeName = '/job_favorite';

  JobFavoriteViewModel? _viewModel;

  JobFavoriteView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BaseView<JobFavoriteViewModel>(
  ...
  Widget _contentView(BuildContext context, JobFavoriteViewModel viewModel) =>
      Scaffold(
        body: Container(
          ...
          child: Column(
            ...
            children: [
              Toolbar(
                title: S.of(context).careerSaved,
                isLeftButton: false,
              ),
  ...
  jobList(JobFavoriteViewModel viewModel) => ListView.builder(
